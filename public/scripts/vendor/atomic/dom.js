...
import { protocol, first as first$2, overload } from 'atomic/core';
import * as $ from 'atomic/reactives';
import * as mut from 'atomic/transients';
export { after, append, before, empty, omit, prepend } from 'atomic/transients';
import { HTMLDocument, document as document$1, Element, Comment, DocumentFragment, Window, Text, HTMLCollection, HTMLInputElement, HTMLSelectElement, Location, NodeList, XMLDocument } from 'dom';
import 'promise';
...
var element = _.assume(isHTMLDocument, document$1, _.curry(function element(document, name) {
...
var elementns = _.assume(isHTMLDocument, document$1, _.curry(function elementns(document, ns, name) {
...
var fragment = _.assume(isHTMLDocument, document$1, function fragment(document) {
  var _contents, _embed;
...
var spaceSep = overload(null, spaceSep1, spaceSep2);
...
var ready = _.assume(isHTMLDocument, document$1, function ready(document, callback) {
...
function tags0() {
  return tags1(element(document$1));
}
...
var tag = tags();
var option = _.assume(isHTMLDocument, document$1, _.overload(null, null, function option(document, entry) {
...
var select = _.called(_.assume(isHTMLDocument, document$1, function select(document, entries) {
...
var checkbox = _.called(_.assume(isHTMLDocument, document$1, function checkbox(document) {
...
var input = _.called(_.assume(isHTMLDocument, document$1, function input(document) {
...
(function () {
  function embeddables(self, doc) {
    return [(doc || document$1).createTextNode(self)];
  }

  function toFragment(self, doc) {
    return (doc || document$1).createRange().createContextualFragment(self);
  }
...
(function () {
  function toFragment(self, doc) {
    return (doc || document$1).createRange().createContextualFragment("");
  }
...
export { Attrs, IContent, IEmbeddable, IHideable, IHtml, IMountable, ISelectable, IText, IValue, InvalidHostElementError, NestedAttrs, Props, SpaceSeparated, addClass, addStyle, assert, attr, attrs, behave, behaviors, checkbox, classes, contents$2 as contents, element, elementns, embed, embeddables$2 as embeddables, enable, fragment, hasClass, hide$1 as hide, html$1 as html, input, isElement, isHTMLDocument, isMountable, isVisible, markup, mount, mounts, nestedAttrs, option, prop, props, ready, removeAttr, removeClass, removeStyle, replaceWith, sel$2 as sel, sel1$1 as sel1, select, show$1 as show, spaceSep, style, tag, tags, text$2 as text, textbox, toFragment, toggle$1 as toggle, toggleClass, value$2 as value, wrap };
