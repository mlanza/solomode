...
var behave$B = does(iequiv, implement(ISequential$1), implement(IBlankable, {
...
var behave$A = does((_naming$b = naming, _Symbol2$b = _Symbol("Number"), function naming(_argPlaceholder) {
  return _naming$b(_argPlaceholder, _Symbol2$b);
...
var behave$z = does((_naming$a = naming, _Symbol2$a = _Symbol("Boolean"), function naming(_argPlaceholder) {
  return _naming$a(_argPlaceholder, _Symbol2$a);
}), implement(IComparable, {
  compare: compare$4
}), implement(IInverse, {
  inverse: inverse$2
...
var behave$y = does((_naming$9 = naming, _Symbol2$9 = _Symbol("Nil"), function naming(_argPlaceholder) {
  return _naming$9(_argPlaceholder, _Symbol2$9);
}), implement(IClonable, {
  clone: identity
...
var behave$x = does(implement(IDeref, {
  deref: deref$7
}));
...
var behave$w = does(emptyable, implement(IReduce, {
  reduce: reduce$b
}), implement(IKVReduce, {
  reducekv: reducekv$9
}), implement(IEquiv, {
...
var behave$v = does(behave$w, implement(IMap, {
  keys: keys$9
}), implement(ICoercible, {
...
var behave$u = does(iterable, iequiv, implement(ISequential$1), implement(IIndexed, {
  nth: nth$4,
  idx: idx$1
}), implement(IReversible, {
  reverse: reverse$2
...
var behave$t = does(iterable, implement(ISequential$1), implement(ICounted, {
  count: count$8
}), implement(IIndexed, {
  nth: nth$3
}), implement(ILookup, {
...
var behave$s = does((_naming$8 = naming, _Symbol2$8 = _Symbol("Array"), function naming(_argPlaceholder) {
  return _naming$8(_argPlaceholder, _Symbol2$8);
...
var behave$r = does(implement(IBounds, {
  start: start$1,
  end: end$1
}));
...
var behave$q = does(iterable, implement(IReduce, ilazyseq), implement(IKVReduce, ilazyseq), implement(ISequential$1), implement(IEmptyableCollection, {
  empty: emptyList
}), implement(IKVReduce, {
  reducekv: reducekv$5
}), //TODO!!
...
var behave$p = does(implement(IKVReduce, {
  reducekv: reducekv$4
}), implement(IAddable, {
  add: merge$2
}), implement(IMergable, {
...
var behave$o = does((_naming$7 = naming, _Symbol2$7 = _Symbol("Date"), function naming(_argPlaceholder) {
  return _naming$7(_argPlaceholder, _Symbol2$7);
}), implement(IAddable, {
  add: add$1
}), implement(IDeref, {
  deref: deref$6
...
var behave$n = does(implement(IForkable, {
  fork: fork$7
}), implement(IFunctor, {
  fmap: identity
}));
...
var behave$m = does(implement(IDeref, {
  deref: deref$5
}), implement(IFunctor, {
  fmap: fmap$7
}));
...
var behave$l = does(implement(IEquiv, {
  equiv: equiv$4
...
behave$l(FiniteStateMachine);

Function.prototype[_Symbol.toStringTag] = "Function";

var _Symbol2$6, _naming$6;
function append$2(f) {
...
var behave$k = does((_naming$6 = naming, _Symbol2$6 = _Symbol("Function"), function naming(_argPlaceholder) {
  return _naming$6(_argPlaceholder, _Symbol2$6);
}), implement(INamable, {
  name: name
}), implement(IAppendable, {
  append: append$2
...
var _Symbol2$5, _naming$5;

function equiv$3(self, other) {
  return kin(self, other) && self.id === other.id;
}

var behave$j = does((_naming$5 = naming, _Symbol2$5 = _Symbol("GUID"), function naming(_argPlaceholder) {
  return _naming$5(_argPlaceholder, _Symbol2$5);
}), implement(IEquiv, {
  equiv: equiv$3
}));
...
var behave$i = does(iterable, implement(IReduce, ilazyseq), implement(IKVReduce, ilazyseq), implement(ISequential$1), implement(IInclusive, {
  includes: includes$5
}), implement(IIndexed, {
  nth: nth$1
}), implement(ILookup, {
...
function leaves(self) {
  return remove(comp(count$d, children$1), descendants$1(self));
}
...
var behave$h = does(implement(IDeref, {
  deref: deref$4
}), implement(IFunctor, {
  fmap: fmap$6
}), implement(ILookup, {
...
var behave$g = does(implement(IDeref, {
  deref: deref$3
}), implement(IForkable, {
  fork: fork$5
}), implement(IFunctor, {
...
var behave$f = does(implement(IPath, {
  path: path
}), implement(ICollection, {
  conj: conj$2
}), implement(ILookup, {
...
var behave$e = does(ilazyseq, implement(ISeqable, {
  seq: identity
}), implement(ISeq, {
  first: first$4,
  rest: rest$4
...
var behave$d = does(implement(IDeref, {
  deref: deref$1
}), implement(IForkable, {
  fork: fork$4
}), implement(IOtherwise, {
...
var behave$c = does((_naming$4 = naming, _Symbol2$4 = _Symbol("Object"), function naming(_argPlaceholder3) {
  return _naming$4(_argPlaceholder3, _Symbol2$4);
}), implement(ITemplate, {
  fill: fill$1
}), implement(IBlankable, {
  blank: blank$1
...
var behave$b = does(implement(IForkable, {
  fork: fork$3
}), implement(IFunctor, {
  fmap: fmap$3
}));
...
var behave$a = does(iequiv, implement(ICoercible, {
  toObject: toObject
}), implement(IFind, {
  find: find
}), implement(IMap, {
...
var behave$9 = does(emptyable, implement(ISplittable, {
  split: split$1
}), implement(IAddable, {
  add: add
}), implement(IMergable, {
...
var behave$8 = does((_naming$3 = naming, _Symbol2$3 = _Symbol("Promise"), function naming(_argPlaceholder) {
  return _naming$3(_argPlaceholder, _Symbol2$3);
}), implement(IOtherwise, {
...
var behave$7 = does(iterable, emptyable, implement(ISequential$1), implement(IInverse, {
  inverse: inverse
}), implement(IIndexed, {
  nth: nth
}), implement(ICounted, {
...
var _Symbol2$2, _naming$2;
var behave$6 = (_naming$2 = naming, _Symbol2$2 = _Symbol("RegExp"), function naming(_argPlaceholder) {
  return _naming$2(_argPlaceholder, _Symbol2$2);
});
...
var behave$5 = does(implement(IDeref, {
  deref: deref
}), implement(IForkable, {
  fork: fork$1
}), implement(IOtherwise, {
...
var behave$4 = does(iindexed, (_naming$1 = naming, _Symbol2$1 = _Symbol("String"), function naming(_argPlaceholder) {
  return _naming$1(_argPlaceholder, _Symbol2$1);
...
var behave$3 = does(implement(IChainable, {
  chain: chain
}), implement(IForkable, {
  fork: fork
}), implement(IFunctor, {
...
var behave$2 = does(behave$j, (_naming = naming, _Symbol2 = _Symbol("UID"), function naming(_argPlaceholder) {
...
function impart(self, f) {
  ...
  return reducekv$b(function (memo, key, value) {
    return assoc$a(memo, key, impartable(value) ? f(value) : value); //impart to functions which are not also constructors
  }, {}, self);
}
...
export { AssociativeSubset, Benchmark, Concatenated, Duration, EmptyList, FiniteStateMachine, Fluent, GUID, IAddable, IAppendable, IAssociative, IBlankable, IBounds, IChainable, IClonable, ICoercible, ICollection, ICompactible, IComparable, ICounted, IDeref, IDisposable, IDivisible, IEmptyableCollection, IEquiv, IFind, IFn, IForkable, IFunctor, IHandler, IHierarchy, IIdentifiable, IInclusive, IIndexed, IInsertable, IInverse, IKVReduce, ILookup, IMap, IMapEntry, IMatchable, IMergable, IMultipliable, INamable, INext, IOmissible, IOtherwise, IPath, IPrependable, IReduce, IReset, IReversible, IRevertible, ISend, ISeq, ISeqable, ISequential$1 as ISequential, ISet, ISplittable, IStateMachine, ISwap, ITemplate, Indexed, IndexedSeq, Journal, LazySeq, Left, Lens, List, Maybe, Multimap, Nil, Okay, Period, Protocol, ProtocolLookupError, Range, Recurrence, Reduced, RevSeq, Right, Task, UID, absorb, add$3 as add, after, ako, alike, all, also, ancestors, and, annually, any, append$1 as append, apply, applying, arity, array, asLeaves, asc, assoc$a as assoc, assocIn, associativeSubset, assume, attach, average$1 as average, awaits, before, behave, behaves, behaviors, benchmark, best, between, binary, blank$2 as blank, blot, bool, _boolean as boolean, both, braid, branch, butlast, called, camelToDashed, chain$1 as chain, children$1 as children, clamp, cleanly, clockHour, clone$5 as clone, closest$2 as closest, coalesce, collapse, comp, compact$1 as compact, compare$6 as compare, compile, complement, concat, concatenated, cond, conj$8 as conj, cons, constantly, construct, constructs, contains$a as contains, count$d as count, countBy, curry, cycle, date, day, days, debug, dec, deconstruct, dedupe, defaults, deferring, deref$8 as deref, desc, descendants$1 as descendants, descriptive$1 as descriptive, detach, detect, difference, directed, disj, dispose, dissoc$6 as dissoc, divide$2 as divide, doall, does, doing, dorun, doseq, dotimes, doto, dow, downward, drop, dropLast, dropWhile, duration, each, eachIndexed, eachkv, eachvk, edit, either, elapsed, empty$1 as empty, emptyArray, emptyList, emptyObject, emptyPeriod, emptyRange, emptyRecurrence, emptyString, end$2 as end, endsWith, entries, eod, eom, eoy, eq, equiv$9 as equiv, equivalent, error, every, everyPair, everyPred, excludes, execute, expands, extend, factory, fill$2 as fill, filled, filter, filtera, find$2 as find, first$d as first, flatten, flip, _float as float, fluent, flush$1 as flush, fmap$b as fmap, fmt, fnil, fold, folding, foldkv, fork$6 as fork, forward, forwardTo, fromQueryString, fromTask, fsm, generate, get, getIn, groupBy, gt, gte, guard, guid, handle, handles, hour, hours, iarray, identifier, identity, idx$3 as idx, impart, implement, implement0, inc, include, includes$9 as includes, inclusive, index, indexOf, indexed, indexedSeq, info, initial, inside, _int as int, integers, interleave, interleaved, interpose, intersection, into, inverse$1 as inverse, invoke, invokes, is, isArray, isBlank, isBoolean, isDate, isDistinct, isEmpty, isError, isEven, isFalse, isFloat, isFunction, isIdentical, isInt, isInteger, isNaN, isNative, isNeg, isNil, isNumber, isObject, isOdd, isPos, isPromise, isReduced, isRegExp, isSome, isString, isSymbol, isTrue, isWeakMap, isZero, iterable, iterate$1 as iterate, join, journal, just, juxt, juxtVals, keep, keepIndexed, key, keyed, keys$b as keys, kin, last, lazyIterable, lazySeq, least, leaves, left, left1, lens, list, log, lowerCase, lpad, lt, lte, ltrim, map, mapArgs, mapIndexed, mapKeys, mapSome, mapVals, mapa, mapcat, mapkv, mapvk, matches$1 as matches, max, maxKey, maybe, mdow, measure, memoize, merge$4 as merge, mergeWith, midnight, millisecond, milliseconds, min, minKey, minute, minutes, mod, month, monthDays, months, most$1 as most, mult$2 as mult, multi, multimap, name$1 as name, naming, nary, negatives, next$a as next, nextSibling$2 as nextSibling, nextSiblings$2 as nextSiblings, nil, noon, noop, not, notAny, notEmpty, notEq, notEvery, notSome, nth$6 as nth, nullary, num, number, numeric, obj, object, okay, omit$3 as omit, once, only, opt, or, otherwise$3 as otherwise, overlap, overload, parent$1 as parent, parents$2 as parents, partial, partition, partitionAll, partitionAll1, partitionAll2, partitionAll3, partitionBy, partly, patch, path$1 as path, period, period1, pipe, pipeline, placeholder, plug, pm, positives, post, pre, prepend$2 as prepend, prevSibling$2 as prevSibling, prevSiblings$2 as prevSiblings, promise, prop, protocol, quarter, quaternary, race, rand, randInt, randNth, range, rdow, reFind, reFindAll, reMatches, rePattern, reSeq, readable, realize, realized, record, recurrence, recurrence1, recurs, redo$1 as redo, redoable$1 as redoable, reduce$f as reduce, reduced$1 as reduced, reducekv$b as reducekv, reducekv2, reducekv3, reducing, reifiable, remove, removeKeys, repeat, repeatedly, replace, reset$1 as reset, rest$d as rest, revSeq, reverse$4 as reverse, rewrite, right, root$2 as root, rpad, rtrim, satisfies, scan, scanKey, second, seconds, see, seek, selectKeys, send, seq$a as seq, serieslike, shuffle, siblings$2 as siblings, signature, signatureHead, slice, sod, som, some$1 as some, someFn, sort, sortBy, soy, specify, splice, split$2 as split, splitAt, splitWith, spread, start$2 as start, startsWith, state, steps, str, subj, subs, subset, subsumes, subtract, sum, superset, swap$1 as swap, take, takeLast, takeNth, takeWhile, task, tee, template, ternary, test, thrush, tick, time, titleCase, toArray$7 as toArray, toDuration$1 as toDuration, toObject$3 as toObject, toPromise, toQueryString, toggles, trampoline, transduce, transition, transitions, transpose, treeSeq, trim, type, uid, unary, unbind, unconj$1 as unconj, undo$1 as undo, undoable$1 as undoable, union, unique, unite, unreduced, unspecify, unspread, untick, update, updateIn, upperCase, upward, val, vals$6 as vals, warn, weakMap, weekday, weekend, weeks, when, withIndex, writable, xarg, xargs, yank, year, years, zeros, zip };
