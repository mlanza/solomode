define(['exports', 'immutable', 'atomic/core', 'atomic/transients'], function (exports, imm, _$1, mut) { 'use strict';
  ...
  function reducekv(self, xf, init) {
    return _$1.IReduce.reduce(keys$1(self), function (memo, key) {
  ...
  function _transient(self) {
    return mut.transientSet(toArray$2(self));
  }
  ...
  var cache = _$1.Symbol["for"]("hashCode");
  ...
  exports.Map = imm.Map;
  exports.Set = imm.Set;
  exports.OrderedMap = imm.OrderedMap;
  exports.OrderedSet = imm.OrderedSet;
