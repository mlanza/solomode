...
Learn solo modes released to the [Line Up](./categories.md) in early December in preparation for January 2022.  Play as few or as many solo modes as you like over the month of January.  Record each discrete play as a post in the thread belonging to the solo mode.  Begin the post with LIKE, LOVE or LUMP, in caps on a line all by itself.  Optionally, use the remainder of the post to offer feedback to its creator.
